...
# PATH
export PATH="$YAGARTO_ELF/bin:$YAGARTO_NONE/bin:$VMWARE_TOOLS:$LIBEXEC:$GIT_SCRIPTS:$LATEX_BIN_DIR:$ALT_X11_DIR/bin:$MACPORTS_DIR/bin:$MACPORTS_DIR/sbin:$MANUALLY_INSTALLED_DIR/bin:$MANUALLY_INSTALLED_DIR/sbin:$APPLE_DEVELOPER_DIR/bin:$APPLE_DEVELOPER_DIR/sbin:$MY_APPLICATIONS_DIR:$DEVELOPER_TOOLS_COMMAND_LINE:/bin:/sbin:/usr/bin:/usr/sbin:/usr/libexec:$X11_DIR/bin:."
export MANPATH="$JAVA_HOME/man:$YAGARTO_ELF/share/man:$YAGARTO_NONE/share/man:$ALT_X11_DIR/share/man:$MACPORTS_DIR/share/man:$MANUALLY_INSTALLED_DIR/man:$MANUALLY_INSTALLED_DIR/share/man:$X11_DIR/share/man:$APPLE_DEVELOPER_DIR/share/man:/usr/share/man:/opt/local/etc/zsh/man/"
